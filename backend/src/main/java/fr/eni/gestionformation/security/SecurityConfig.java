    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/formateurs/*/planning").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/eleves").hasAnyRole("ADMINISTRATEUR", "REFERENTE_ADMINISTRATIVE")
                .requestMatchers(HttpMethod.GET, "/api/formateurs").hasAnyRole("ADMINISTRATEUR", "REFERENTE_ADMINISTRATIVE")
